...
variable "guard_duty_s3_bucket_arn" {
  description = "The ARN of the S3 bucket where GuardDuty will store findings."
  type        = string
}

variable "guard_duty_kms_arn" {
  description = "The ARN of the KMS Key where GuardDuty will store findings."
  type        = string
}


variable "enabled_export_to_s3" {
  description = "Define whether enable GuardDuty Export to S3 or not."
  type        = bool
  default     = true
}